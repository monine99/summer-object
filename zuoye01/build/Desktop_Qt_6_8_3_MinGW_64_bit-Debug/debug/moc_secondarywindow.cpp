...
static constexpr auto qt_meta_stringdata_ZN15SecondaryWindowE = QtMocHelpers::stringData(
    "SecondaryWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15SecondaryWindowE[] = {
...
Q_CONSTINIT const QMetaObject SecondaryWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15SecondaryWindowE.offsetsAndSizes,
    qt_meta_data_ZN15SecondaryWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15SecondaryWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *SecondaryWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15SecondaryWindowE.stringdata0))
